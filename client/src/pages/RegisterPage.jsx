...
const RegisterPage = () => {
  ...
  return (
    <div className="grid min-h-screen grid-cols-1 lg:grid-cols-[480px_1fr]">
      ...
      {/* ── Right: Visual panel ── */}
      <div className="auth-hero-panel hidden lg:flex flex-col items-center justify-center relative overflow-hidden p-16 animate-fade-in min-h-screen"
        style={{ animationDelay: '0.1s', animationFillMode: 'both' }}>
        
        {/* Top Right Info Icon */}
        <div className="absolute top-12 right-12 group z-50">
          <div className="auth-icon-btn w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 cursor-help">
          ...
          {/* Tooltip Popup */}
          <div className="auth-tooltip absolute right-0 top-14 w-[340px] p-6 rounded-2xl backdrop-blur-xl opacity-0 translate-y-3 invisible group-hover:opacity-100 group-hover:translate-y-0 group-hover:visible transition-all duration-300">
            ...
            <ol className="flex flex-col gap-4 relative">
              {/* Vertical line */}
              <div className="auth-tooltip-divider absolute left-[9px] top-2 bottom-2 w-[2px] rounded-full"></div>
              ...
              <li className="flex items-start gap-4 relative opacity-0 -translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 delay-100">
                <div className="w-[20px] h-[20px] rounded-full bg-[#10B981] flex-shrink-0 mt-0.5 auth-tooltip-dot relative z-10 shadow-[0_0_12px_rgba(16,185,129,0.5)] animate-pulse"></div>
                <div>
              ...
              <li className="flex items-start gap-4 relative opacity-0 -translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 delay-200">
                <div className="w-[20px] h-[20px] rounded-full bg-[#3B82F6] flex-shrink-0 mt-0.5 auth-tooltip-dot relative z-10 shadow-[0_0_12px_rgba(59,130,246,0.5)] animate-pulse" style={{ animationDelay: '0.2s' }}></div>
                <div>
              ...
              <li className="flex items-start gap-4 relative opacity-0 -translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 delay-300">
                <div className="w-[20px] h-[20px] rounded-full bg-[#8B5CF6] flex-shrink-0 mt-0.5 auth-tooltip-dot relative z-10 shadow-[0_0_12px_rgba(139,92,246,0.5)] animate-pulse" style={{ animationDelay: '0.4s' }}></div>
                <div>
